(function() {
  ...
  Phone = (function() {
    function Phone() {
      ...
      this.validateInternational = __bind(this.validateInternational, this);
      this.validateNational = __bind(this.validateNational, this);
    ...
    Phone.prototype.validateInternational = function(number, givenCountryCode, givenNationalDestinationCode) {
      ...
      return this.validateNational(withoutCountryCode, countryCode, givenNationalDestinationCode);
    };
...
(function() {
  ...
  Argentina = (function() {
    function Argentina() {
      ...
      this.countryCode = '54';
      this.mask = "(9[9][9]) [99] [9][9]99-9999";
    ...
    Argentina.prototype.splitNumber = function(number) {
      ...
      switch (number.length) {
        case 8:
          ...
          return _.filter(splitNumber, function(n) {
            return n.length >= 1;
          });
        case 7:
...
(function() {
  ...
  Chile = (function() {
    ...
    Chile.prototype.splitNumber = function(number) {
      ...
      switch (number.length) {
        case 9:
          splitNumber = number.split(/(\d{1})(\d{4})(\d{4})/);
          return _.filter(splitNumber, function(n) {
            return n.length >= 1;
          });
        case 8:
